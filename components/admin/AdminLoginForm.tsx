  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5 rounded-[24px] border border-white/10 bg-white/[0.03] p-8">
      ...
      <button
        type="submit"
        disabled={busy}
        className="w-full inline-flex min-h-11 items-center justify-center rounded-full bg-gold px-8 py-4 text-xs font-bold tracking-widest text-on-gold uppercase transition-all hover:bg-gold-dark disabled:opacity-60"
      >
        {busy ? "Accesso…" : "Accedi"}
      </button>
