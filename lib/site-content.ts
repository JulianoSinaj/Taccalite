...
export const SITE_CONTENT: ContentDef[] = [
  ...
  },
  {
    ...
    help:
      "Un servizio per riga: titolo | testo | link | testo del link | colore | immagine.",
    group: HOME,
    type: "records",
    fields: ["title", "body", "href", "cta", "accent", "image"],
    default: [
      "Aperitivi | Taglieri di salumi e formaggi composti al momento su quello che c'è di buono quel giorno. Da portare via o da aprire in compagnia. | /negozio | Guarda la selezione | var(--acc-formaggi) | /images/salumi-appesi-stagionatura.jpg",
      "Asporto | Gastronomia pronta, primi e secondi del giorno, olive all'ascolana appena fritte. Ordina la mattina, passi quando ti fa comodo. | /negozio | Ordina online | var(--acc-gastronomia) | /images/gastronomia-teglie-forno.jpg",
      "Domicilio | Portiamo la spesa a casa ad Ancona e dintorni. Per la consegna in giornata basta chiamare entro mezzogiorno. | /contatti | Chiedi la consegna | var(--acc-carni) | /images/pasta-artigianale-bottega.jpg",
      "Catering | Compleanni, uffici, feste di famiglia. Prepariamo noi: dal tagliere per otto al buffet completo, concordato voce per voce. | /contatti | Richiedi un preventivo | var(--acc-salumi) | /images/spiedini-verdure-banco.jpg",
      "Richieste speciali | Una forma intera, un taglio che non trovi, una porchetta per cinquanta persone. Se esiste ve la troviamo, se serve tempo ve lo diciamo. | /contatti | Scrivici | var(--acc-regalo) | /images/banco-carni-vetrina.jpg",
    ].join("\n"),
  },
  {
